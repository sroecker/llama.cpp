...
ggml_tensor * llm_graph_context::build_lora_mm_id(
    ...
    if (w_s) {
        ...
        s = ggml_repeat_4d(ctx0, s, 1, w_s->ne[0], ids->ne[1], 1);
...
ggml_tensor * llm_graph_context::build_moe_ffn(
     ...
     llm_ffn_op_type   type_op,
         ...
         ggml_tensor * gate_up_exps_in_s) const {
...
ggml_tensor * llm_graph_context::build_moe_ffn(
    ...
    if (gate_up_exps) {
        ...
        ggml_tensor * gate_up = build_lora_mm_id(gate_up_exps, cur, selected_experts, gate_up_exps_s, gate_up_exps_in_s); // [n_ff*2, n_expert_used, n_tokens]
